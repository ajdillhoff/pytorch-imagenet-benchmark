...
def validate(val_loader, model, criterion, epoch, start_time):
    ...
    print('{0}\t{1}\t{2:.3f}'.format(epoch, float(time_diff.total_seconds() / 3600.0), top5.avg))
    log_epoch(args.log_path, epoch, float(time_diff.total_seconds() / 3600.0), top1.avg, top5.avg)
